...
export default class wScore extends Component{
        ...
        return(
            <div className="ScoreBox">
                ...
                <div className="ScoreTitleBoxRule">
                    ...
                    <div className="ScoreTitleBoxRuleAA">
                        <div>大会主席团和专家顾问团组成奖项评委会，召开评审会议，根据报名申请进行奖项评选，
                            综合商议后评选出最终获奖入围名单。奖项评选过程与结果将由大会组委会监督核查。
                        </div>
                        <div>投票：1票=1分</div>
                    </div>
                </div>
